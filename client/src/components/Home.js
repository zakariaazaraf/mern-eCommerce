  ...
  <section class='product d-flex'>
    <article>
        <a href="/products/<%=product.id%>">
            ...
            <div class="content">
                <h3 class="title">This the product 1</h3>
    ...
    <article>
        <a href="/products/<%=product.id%>">
            ...
            <div class="content">
                <h3 class="title">This the product 2</h3>
                <span class="price">$100</span>
                <span class="shop-link">shop now</span>
            </div>
        </a>
    ...
    <article>
        <a href="/products/<%=product.id%>">
            ...
            <div class="content">
                <h3 class="title">This the product 3</h3>
                <span class="price">$100</span>
                <span class="shop-link">shop now</span>
            </div>
        </a>
    ...
    <article>
        <a href="/products/<%=product.id%>">
            ...
            <div class="content">
                <h3 class="title">This the product 4</h3>
                <span class="price">$100</span>
                <span class="shop-link">shop now</span>
            </div>
        </a>
    ...
    <article>
        <a href="/products/<%=product.id%>">
            ...
            <div class="content">
                <h3 class="title">This the product 5</h3>
                <span class="price">$100</span>
                <span class="shop-link">shop now</span>
            </div>
        </a>
    ...
    <article>
        <a href="/products/<%=product.id%>">
            ...
            <div class="content">
                <h3 class="title">This the product 6</h3>
                <span class="price">$100</span>
                <span class="shop-link">shop now</span>
            </div>
        </a>
    ...
    <article>
        <a href="/products/<%=product.id%>">
            ...
            <div class="content">
                <h3 class="title">This the product 7</h3>
                <span class="price">$100</span>
                <span class="shop-link">shop now</span>
            </div>
        </a>
    ...
    <article>
        <a href="/products/<%=product.id%>">
            ...
            <div class="content">
                <h3 class="title">This the product 8</h3>
                <span class="price">$100</span>
                <span class="shop-link">shop now</span>
            </div>
        </a>
    ...
    <article>
        <a href="/products/<%=product.id%>">
            ...
            <div class="content">
                <h3 class="title">This the product 9</h3>
                <span class="price">$100</span>
                <span class="shop-link">shop now</span>
            </div>
        </a>
    ...
    <article>
        <a href="/products/<%=product.id%>">
            ...
            <div class="content">
                <h3 class="title">This the product 10</h3>
                <span class="price">$100</span>
                <span class="shop-link">shop now</span>
            </div>
        </a>
