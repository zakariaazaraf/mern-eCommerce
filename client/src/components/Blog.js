...
export const Blog = () => {
  return <main class='blog-container'>
  <div class="container">
      <div class="intro">
          <p class="title">blog</p>
          <h2 class='header-intro'>Welcome to behind the scenes of L.Novum</h2>
      </div>
      <div class="newsletter-container">
          <div class="blog-post">
              <a href="#" class='blog-link'>
                  <img src="images/ozgeyagizz4.jpg" alt="ozgeyagizz" />
                  <span class="blog-date">18 Oct, 2020</span>
                  <p class="blog-title">ozgeyagizz's new looks in the summer</p>
              </a>
          </div>
          <div class="newsletter-content">
              <p class="title">newsletter</p>
              <h3 class="content">
                  Don’t want to miss latest content?<br />
                  Sign up to our newsletter and become part of L.Novum club
              </h3>
              <form action="" class="newsletter-from">
                  <input class='newsletter-email' type="email" placeholder='Enter yout email' name='email' value='' />
                  <input class='btn' type="submit" value='join' name='join' />
              </form>
          </div>
      </div>
      <div class="newsletter-container">
          <div class="post blog-post">
              <a href="#" class='blog-link'>
                  <img src="images/how-it-starts.jpg" alt="ozgeyagizz" />
                  <div class="footer">
                      <div>
                          <span class="blog-date">18 Oct, 2020</span>
                          <p class="blog-title">ozgeyagizz's new looks in the summer</p>
          ...
          <div class="find-us">
              ...
              <p class="description">
                  Every single item comes directly from our workshop, which means no dealer markups and no eye-watering leases on
